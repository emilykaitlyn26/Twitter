...
public class TwitterClient extends OAuthBaseClient {
	...
	public void likeTweet(String tweetContent, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("favorites/create.json");
		RequestParams params = new RequestParams();
		params.put("id", tweetContent);
		client.post(apiUrl, params, "", handler);
	}

	public void unlikeTweet(String tweetContent, JsonHttpResponseHandler handler) {
	...
	public void retweet(String tweetContent, JsonHttpResponseHandler handler) {
	...
	public void unRetweet(String tweetContent, JsonHttpResponseHandler handler) {
